<div class="form-page">
    <div class="page-heading">
        <div class="page-title">Tambah Pendaftaran</div>
        <p class="page-subtitle">Masukkan data pendaftaran peserta.</p>
    </div>

    <div class="soft-card">
        <div class="card-body">
            <form action="<?= BASEURL; ?>/pendaftaran/store" method="POST">
                <div class="mb-3">
                    ...
                    <select name="id_peserta" id="id_peserta" class="form-select">
                        ...
                        <?php foreach ($data['peserta'] as $ps) : ?>
                            <option
                                ...
                                <?= (($data['old']['id_peserta'] ?? '') == $ps['id_peserta']) ? 'selected' : ''; ?>
                            >
                ...
                <div class="mb-3">
                    ...
                    <select id="kd_jurusan" class="form-select" disabled>
                        ...
                        <?php foreach ($data['jurusan'] as $j) : ?>
                            <option
                                value="<?= $j['kd_jurusan']; ?>"
                                <?= (($data['old']['kd_jurusan'] ?? '') == $j['kd_jurusan']) ? 'selected' : ''; ?>
                            >
                    ...
                    <input
                        ...
                        value="<?= htmlspecialchars($data['old']['kd_jurusan'] ?? ''); ?>"
                    >
                ...
                <div class="mb-3">
                    ...
                    <input
                        ...
                        name="tgl_daftar"
                        class="form-control"
                        value="<?= htmlspecialchars($data['old']['tgl_daftar'] ?? ''); ?>"
                    >
                ...
                <div class="mb-3">
                    ...
                    <select name="status" class="form-select">
                        ...
                        <option value="Selesai" <?= (($data['old']['status'] ?? '') === 'Selesai') ? 'selected' : ''; ?>>Selesai</option>
                        <option value="Batal" <?= (($data['old']['status'] ?? '') === 'Batal') ? 'selected' : ''; ?>>Batal</option>
                    </select>
